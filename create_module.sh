...
import (
	"github.com/scarxity/go-gin-clean/modules/$MODULE_NAME/service"
	"github.com/scarxity/go-gin-clean/modules/$MODULE_NAME/validation"
...
import (
	"github.com/scarxity/go-gin-clean/modules/$MODULE_NAME/repository"
	"gorm.io/gorm"
)
...
import (
	"github.com/scarxity/go-gin-clean/modules/$MODULE_NAME/controller"
